...
interface ApiService {
 ...
 @FormUrlEncoded
 @POST("driver/request/ride-start")
 fun rideStart(@Header("Authorization") token :String, @Field("user_id") userid:Int, @Field("request_id") request_id:Int) :Call<startRideResponse>
